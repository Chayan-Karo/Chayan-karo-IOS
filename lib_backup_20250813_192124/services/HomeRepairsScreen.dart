...
class HomeRepairsScreen extends StatelessWidget {
@override
        ...
        Padding(
          ...
          child: SingleChildScrollView(
            padding: EdgeInsets.only(
              bottom: 120.r + MediaQuery.of(context).viewPadding.bottom + 8.h,
            ),
            child: Column(
  ...
  return Positioned(
    ...
    child: Builder(
      builder: (context) {
        ...
        return Container(
          padding: EdgeInsets.fromLTRB(16.h, 12.h, 16.h, (bottomPadding > 0 ? bottomPadding : 16.h) + 8.h),
        ...
        return Column(
          ...
          children: [
            ...
            ...services.map((service) {
              if (!category.toLowerCase().contains('wall')) {
