...
import '../../controllers/ac_service_controller.dart';
...
class _ACServicesScreenState extends State<ACServicesScreen> {
  final ScrollController _scrollController = ScrollController();
  final ACServiceController controller = Get.put(ACServiceController());
  ...
  static const String SOURCE_PAGE = 'ac_services';
  static const String SOURCE_TITLE = 'AC Services';

  final Map<String, GlobalKey> _categoryKeys = {
    'AC Installation': GlobalKey(),
    'AC Uninstallation': GlobalKey(),
    'Wet Servicing': GlobalKey(),
    'Dry Servicing': GlobalKey(),
    'Gas Refill': GlobalKey(),
    'Repair & Checkup': GlobalKey(),
  };

  final Map<String, String> _serviceToCategory = {
    'ac_service_0': 'AC Installation',
    'ac_service_3': 'AC Installation',
    'ac_service_1': 'AC Uninstallation',
    'ac_service_2': 'AC Uninstallation',
    'ac_service_4': 'Wet Servicing',
    'window_ac_wet_servicing': 'Wet Servicing',
  };

  final Map<String, String> _categoryGridToSection = {
    'AC Installation': 'AC Installation',
    'AC Uninstallation': 'AC Uninstallation',
    'Wet Servicing': 'Wet Servicing',
    'Dry Servicing': 'Wet Servicing',
    'Gas Refill': 'AC Installation',
    'Repair & Checkup': 'AC Uninstallation',
  };

  @override
  void initState() {
    super.initState();
    print('🟢 ACServicesScreen initialized with scrollToServiceId: ${widget.scrollToServiceId}');
  ...
  void _onCategoryGridTap(String categoryTitle) {
    ...
    if (targetSection != null) {
      ...
      _scrollToCategory('AC Installation');
    }
  }
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: controller.groupedServices.entries.map((entry) {
            ...
            final List<ACService> services = entry.value;
            return Container(
  ...
  Widget _buildServiceCard(ACService service, double scaleFactor, String category) {
    if (category == 'Wet Servicing') {
      return _buildWetServiceCard(service, scaleFactor);
    } else {
      return _buildRegularServiceCard(service, scaleFactor);
    }
  }

  Widget _buildRegularServiceCard(ACService service, double scaleFactor) {
    return Container(
  ...
  Widget _buildWetServiceCard(ACService service, double scaleFactor) {
    return Container(
      margin: EdgeInsets.only(bottom: 16.r * scaleFactor),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildQuantitySelector(ACService service, double scaleFactor) {
    return Obx(() {
