...
class _ApiService implements ApiService {
  ...
  Future<HomeData> getHomeData() async {
    ...
    final _options = _setStreamType<HomeData>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<ServiceCategory>> getCategories() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ServiceCategory>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data!
          .map((dynamic i) =>
              ServiceCategory.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<List<GoToService>> getGoToServices() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GoToService>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<Service>> getMostUsedServices() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Service>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
