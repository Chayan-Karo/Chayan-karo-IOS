              ...
              return _buildBannerContent(
                ...
                onTap: () {
                  FirebaseAnalytics.instance.logEvent(
                    ...
                    parameters: {
                      'banner_id': banner.id ?? '',
                      'banner_title': banner.description ?? '',
                      'category_id': banner.category?.id ?? '',
                      'service_category_id': banner.serviceCategory?.id ?? '',
                    },
                  );
                  ...
                  if (targetCategoryId != null) {
                    ...
                    final realCategory = categoryController.filteredCategories
                        .firstWhereOrNull(
              ...
              Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(
                    12.5.r * scaleFactor,
                  ), // Slightly less than parent for border
