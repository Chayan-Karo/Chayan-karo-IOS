  ...
  Widget build(BuildContext context) {
    return Consumer<HomeViewModel>(
      builder: (context, viewModel, child) {
        return _buildServiceSection(context, title, viewModel.goToServices);
      },
    );
  }

  Widget _buildServiceSection(BuildContext context, String title, List<Map<String, dynamic>> data) {
